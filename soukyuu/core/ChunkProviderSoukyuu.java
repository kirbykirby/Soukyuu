...
import soukyuu.wgen.BiomeGenSkyland;
import soukyuu.wgen.SkyGenFlowers;
import soukyuu.wgen.SkyGenLakes;
import soukyuu.wgen.SkyGenLiquids;
import soukyuu.wgen.SkyGenMinable;

public class ChunkProviderSoukyuu
    implements IChunkProvider
{
    ...
    public ChunkProviderSoukyuu(World world, long l)
    {
    ...
    public void func_28072_a(int i, int j, byte abyte0[])
    {
        ...
        for(int k = 0; k < 16; k++)
        {
            for(int l = 0; l < 16; l++)
            {
                ...
                int j1 = -1;
                topBlock = (byte)InitBlock.skyGrass.blockID;
                fillerBlock = (byte)InitBlock.skyDirt.blockID;
                byte byte0 = topBlock;
                byte byte1 = fillerBlock;
                byte byte2 = (byte)InitBlock.skyStone.blockID;
                if(byte0 < 0)
                {
                    byte0 += 0;
                }
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i10 = 0; i10 < 50; i10++)
        {
            ...
            (new SkyGenLakes(Block.waterMoving.blockID)).generate(worldObj, random, i15, i18, k18);
        }
        ...
        for(int j1 = 0; j1 < 20; j1++)
        {
            ...
            (new SkyGenMinable(InitBlock.skyDirt.blockID, 32)).generate(worldObj, random, l5, l10, k15);
        }
        ...
        for(int i10 = 0; i10 < 40; i10++)
        {
            ...
            int i18 = random.nextInt(random.nextInt(120) + 8);
            int k18 = l + random.nextInt(16) + 8;
            (new SkyGenLiquids(Block.waterMoving.blockID)).generate(worldObj, random, i15, i18, k18);
        }
