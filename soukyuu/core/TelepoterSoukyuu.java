...
public class TelepoterSoukyuu extends Teleporter {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
		...
		if (this.longHashMap.containsItem(var17)) {
			PortalPosition var20 = (PortalPosition) this.longHashMap.getValueByKey(var17);
			var10 = 0.0D;
			var12 = var20.posX;
			var13 = var20.posY;
			var14 = var20.posZ;
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
					...
					for (int var26 = this.worldServer.getActualHeight() - 1; var26 >= 0; --var26) {
						if (this.worldServer.getBlockId(var48, var26, var23) == InitBlock.portal.blockID) {
							while (this.worldServer.getBlockId(var48, var26 - 1, var23) == InitBlock.portal.blockID) {
								--var26;
							}
		...
		if (var10 >= 0.0D) {
			if (var19) {
				this.longHashMap.add(var17, new PortalPosition(this, var12, var13, var14, this.worldServer.getTotalWorldTime()));
			...
			if (this.worldServer.getBlockId(var12 - 1, var13, var14) == InitBlock.portal.blockID) {
				var50 = 2;
			}
			...
			if (this.worldServer.getBlockId(var12, var13, var14 - 1) == InitBlock.portal.blockID) {
				var50 = 3;
			}
		...
		for (var19 = 0; var19 < 4; ++var19) {
			...
			for (var20 = 0; var20 < 4; ++var20) {
				for (var21 = -1; var21 < 4; ++var21) {
					...
					this.worldServer.setBlockWithNotify(var22, var23, var24, var33 ? Block.obsidian.blockID : InitBlock.portal.blockID);
				}
			}
	...
	public void func_85189_a(long par1) {
		if (par1 % 100L == 0L) {
			...
			while (var3.hasNext()) {
				...
				PortalPosition var7 = (PortalPosition) this.longHashMap.getValueByKey(var6.longValue());
