...
public class SkyGenMinable extends WorldGenerator
{

    private int minableBlockId;
    private int numberOfBlocks;

    public SkyGenMinable(int i, int j)
    {
        minableBlockId = i;
        numberOfBlocks = j; 
    }
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                        ...
                        if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockId(k2, l2, i3) == InitBlock.skyStone.blockID && world.getBlockMetadata(k2, l2, i3) <= 1)
                        {
